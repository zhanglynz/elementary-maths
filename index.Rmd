...
\end{array}
$$
We use the *method of elimination* to solve the above two equations. To "knock out" the unknown $C$, we subtract $2\times$the first equation from the second equation and we have
$$
2R=84,
$$
from which we get
