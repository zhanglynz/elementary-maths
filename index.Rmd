...
- The meaning of $x^\alpha$, where $x>0$ and $\alpha$ is an arbitrary real number. We need to distinguish the following cases.
    ...
    - **Case 2:** $\alpha<0$, then $x^\alpha=\frac{1}{x^{-\alpha}}$;
    - **Case 3:** $\alpha>0$
        - **sub-case 1:** $\alpha$ is an integer, then $x^\alpha=\underbrace{x\times x\times\cdots \times x}_{\hbox{repeat}\ \alpha\ \hbox{times}}$;
