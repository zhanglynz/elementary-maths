...
We all know that the sum of the three inner angles of a triangle is equal to $180^0$, but why is this true? Below a simple proof answers the question.
...
**Exercise:** Suppose that we set a complete turn is $100^0$ but not $360^2$ any more. Then, what is the sum of the inner angles of a triangle?
